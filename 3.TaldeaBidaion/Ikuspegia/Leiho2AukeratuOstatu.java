...
public class Leiho2AukeratuOstatu extends JFrame {
	...
	private JMenu mnZerbitzua = new JMenu("Zerbitzua");
	private JCheckBoxMenuItem chckbxmntmWifi = new JCheckBoxMenuItem("Wifi");
	private JCheckBoxMenuItem chckbxmntmIgerilekua = new JCheckBoxMenuItem("Igerilekua");
	private JCheckBoxMenuItem chckbxmntmSpa = new JCheckBoxMenuItem("Spa");
	private JCheckBoxMenuItem chckbxmntmParking = new JCheckBoxMenuItem("Parking");
	private JCheckBoxMenuItem chckbxmntmAireGirotua = new JCheckBoxMenuItem("Aire girotua");
	private JCheckBoxMenuItem chckbxmntmJatetxea = new JCheckBoxMenuItem("Jatetxea");
	private JCheckBoxMenuItem chckbxmntmTaberna = new JCheckBoxMenuItem("Taberna");
	private JCheckBoxMenuItem chckbxmntmGimnasioa = new JCheckBoxMenuItem("Gimnasioa");
	...
	public Leiho2AukeratuOstatu() {
		...
		menuBar.add(mnZerbitzua);
		mnZerbitzua.add(chckbxmntmWifi);
		mnZerbitzua.add(chckbxmntmIgerilekua);
		mnZerbitzua.add(chckbxmntmSpa);
		mnZerbitzua.add(chckbxmntmParking);
		mnZerbitzua.add(chckbxmntmAireGirotua);
		mnZerbitzua.add(chckbxmntmJatetxea);
		mnZerbitzua.add(chckbxmntmTaberna);
		mnZerbitzua.add(chckbxmntmGimnasioa);
