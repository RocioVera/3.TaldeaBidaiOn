...
public class Leiho3EtxeDatuak extends JFrame {
	...
	private JLabel lblBinaka = new JLabel("Bikoitza:"),lblSinplea = new JLabel("Sinplea:"), lblUmeak = new JLabel("Umeak:"),lblOheKopuru = new JLabel("Ohe kopuru:");
	private final JLabel lblKomunKop = new JLabel("Komun kopurua:");
	private final JLabel lblSukaldeKopurua = new JLabel("Sukalde kopurua:");
	private final JLabel lblEgongelaKopurua = new JLabel("Egongela kopurua:");
	private final JLabel lblGarajeKopurua = new JLabel("Garaje kopurua:");
	private final JLabel lblLogelaKopurua = new JLabel("Logela kopurua:");
	private final JTextField txtKomunKop = new JTextField();
	private final JTextField txtSukaldeKop = new JTextField();
	private final JTextField txtEgongelaKop = new JTextField();
	private final JTextField txtGarajeKop = new JTextField();
	private final JTextField txtLogelaKop = new JTextField();
	...
	public Leiho3EtxeDatuak(Ostatua hartutakoOstatua, double prezioTot, java.util.Date dataSartze,
		...
		btn_next.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MetodoakLeihoAldaketa.laugarrenLeihoa(hartutakoOstatua, prezioTot, dataSartze, dataIrtetze, 0, pertsonaKop);
				dispose();
			}
		});
